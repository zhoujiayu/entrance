package com.tencent.wxpay.protocol.refund_protocol;
...
public class RefundReqData {
	 ...
	 */
	public RefundReqData(String transactionID, String outTradeNo,
			String deviceInfo, String outRefundNo, int totalFee, int refundFee,
			String opUserID, String refundFeeType, String appId, String mchId,
			String appKey) {
