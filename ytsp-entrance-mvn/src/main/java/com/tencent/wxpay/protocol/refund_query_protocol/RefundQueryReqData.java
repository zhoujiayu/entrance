package com.tencent.wxpay.protocol.refund_query_protocol;
...
/**
 * User: rizenguo Date: 2014/10/25 Time: 16:35
 */
public class RefundQueryReqData {
	 ...
	 * @param refundID
	 *            来自退款API的成功返回，微信退款单号refund_id、out_refund_no、out_trade_no
	 *            、transaction_id
	 *            四个参数必填一个，如果同事存在优先级为：refund_id>out_refund_no>transaction_id
	 *            >out_trade_no
	 */

	public RefundQueryReqData(String transactionID, String outTradeNo,
			String deviceInfo, String outRefundNo, String refundID,
			String appId, String mchId, String appKey) {
