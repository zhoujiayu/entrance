...
/**
 * User: rizenguo Date: 2014/11/12 Time: 17:05
 */
public class ReportReqData {
	 ...
	 * @param appKey
	 */
	public ReportReqData(String deviceInfo, String interfaceUrl,
			int executeTimeCost, String returnCode, String returnMsg,
			String resultCode, String errCode, String errCodeDes,
			String outTradeNo, String userIp, String appId, String mchId,
			String appKey) {
		...
		// 根据API给的签名规则进行签名
		String sign = Signature.getSign(toMap(), appKey);
