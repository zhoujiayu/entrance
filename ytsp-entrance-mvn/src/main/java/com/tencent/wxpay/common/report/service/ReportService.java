package com.tencent.wxpay.common.report.service;
...
/**
 * User: rizenguo Date: 2014/11/12 Time: 17:07
 */
public class ReportService {
	...
	public String request() throws UnrecoverableKeyException,
			KeyManagementException, NoSuchAlgorithmException,
			KeyStoreException, IOException {
		String responseString = new HttpsRequest().sendPost(
				WXPayConfig.REPORT_API, reqData);
		WXUtil.log(" report返回的数据：" + responseString);
	...
	public static String request(ReportReqData reportReqData) throws Exception {
		...
		// --------------------------------------------------------------------
		String responseString = new HttpsRequest().sendPost(
				WXPayConfig.REPORT_API, reportReqData);
	...
	/**
	 * 获取time:统计发送时间，格式为yyyyMMddHHmmss，如2009年12 月25 日9 点10 分10
	 * 秒表示为20091225091010。时区为GMT+8 beijing。
	 * 
	 * @return 订单生成时间
	 */
