...
public class WXLog {
    ...
    public void log(String type,String s){
        if(type.equals(WXLog.LOG_TYPE_TRACE)){
            t(s);
        }else if(type.equals(WXLog.LOG_TYPE_DEBUG)){
            d(s);
        }else if(type.equals(WXLog.LOG_TYPE_INFO)){
            i(s);
        }else if(type.equals(WXLog.LOG_TYPE_WARN)){
            w(s);
        }else if(type.equals(WXLog.LOG_TYPE_ERROR)){
            e(s);
        }
    }
