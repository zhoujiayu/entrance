...
public class HttpClientHelper {
     ...
     * 发送get请求
     */
	public static JSONObject getRequest(String urlToRequest,
			Map<String, String> parameters,String encode){
		StringBuffer response = new StringBuffer();
		JSONObject result = null;
		try {
			InputStream in = invokeRequest(urlToRequest, REQUEST_METHOD.GET, parameters,encode);
    ...
    public static InputStream get(String urlToRequest,
	    Map<String, String> parameters,String encode) {
	return invokeRequest(urlToRequest, REQUEST_METHOD.GET, parameters,encode);
    }

    public static InputStream post(String urlToRequest,
	    Map<String, String> parameters) {
	return invokeRequest(urlToRequest, REQUEST_METHOD.POST, parameters,"UTF-8");
    }

    public static String requestBodyString(String urlToRequest,
	    Map<String, String> parameters) {
	return convertStreamToString(
		invokeRequest(urlToRequest, REQUEST_METHOD.GET, parameters,"UTF-8"),
		"utf-8");
    }
    ...
    public static String postBodyString(String urlToRequest,
	    Map<String, String> parameters) {
	return convertStreamToString(
		invokeRequest(urlToRequest, REQUEST_METHOD.POST, parameters,"UTF-8"),
		"utf-8");
    }

    public static InputStream invokeRequest(String urlToRequest,
	    REQUEST_METHOD method, Map<String, String> parameters,String encode) {
	if (urlToRequest == null || urlToRequest.trim().length() == 0)
	    return null;
	if (parameters == null) {
	    parameters = new HashMap<String, String>();
	}
	String urlParameters = constructURLString(parameters,encode);
     ...
     * @return
     */
    private static String constructURLString(Map<String, String> parameters,String encode) {
	...
	for (Map.Entry<String, String> entry : parameters.entrySet()) {
		...
		url.append(URLEncoder.encode(entry.getKey(), encode) + "="
