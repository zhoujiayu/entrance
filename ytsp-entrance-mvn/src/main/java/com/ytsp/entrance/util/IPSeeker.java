...
public class IPSeeker {
    ...
    //保存的文件夹
    private String INSTALL_DIR="/LumaQQ/";
    ...
    private static Map<String, IPLocation> ipCache;
    // 随机文件访问类
    ...
    public static String[] getAreaNameByIp(String ip)
    {
        ...
        IPSeeker test = new IPSeeker(str,"");
        
        CustomerService customerService = SystemInitialization.getApplicationContext().getBean(CustomerService.class);
    	try {
			CommonRegion commonRegion = customerService.findCodeByName( test.getCountry(ip));
			if(commonRegion != null)
			{
				a[0] = commonRegion.getProvinceCode();
				a[1] = commonRegion.getCityCode();
			}
    ...
    public static String getAreaNameCHByIp(String ip)
    {
		if(!ipCheck(ip))
			return "";
    	String[] a = new String[2];
    	...
    	String str  =url.getPath();
        IPSeeker test = new IPSeeker(str,"");
        String ch = test.getCountry(ip);
    	return ch;
    }
    
    public static void main(String[] args){
        String ip = "";
        System.err.println(ipCheck(ip));
    }
